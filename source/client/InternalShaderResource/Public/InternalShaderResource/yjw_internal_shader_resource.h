...
#define INTERNAL_SHADER_PARAMETER_WITH_ID(ParameterType,ShaderParameterName,VariableName,ID) \
...
#define INTERNAL_SHADER_PARAMETER(ParameterType,ShaderParameterName,VariableName) INTERNAL_SHADER_PARAMETER_WITH_ID(ParameterType,ShaderParameterName,VariableName,__COUNTER__)
...
namespace yjw
{
    ...
    public:
        ...
        INTERNAL_SHADER_PARAMETER(InternalShaderData::Option, option, m_option);
    private:
